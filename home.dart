...
import 'package:crud3/pages/employee.dart';
...
body: Container(
  ...
  Future EditEmploeeDetil(String id)=>showDialog(context: context, builder: (context)=> AlertDialog(
    content: Container(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
